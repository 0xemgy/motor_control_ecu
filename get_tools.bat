...
mklink /D ".\tools\html_report_generator\" "c:\toolchain\html_report_generator\v0.0.1"
mklink /D ".\tools\libclang\" "c:\toolchain\libclang\v18.1.1\"
mklink /D ".\tools\memory_usage_analyzer\" "c:\toolchain\memory_usage_analyzer\v0.0.1"
